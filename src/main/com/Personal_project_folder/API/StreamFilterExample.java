...
public class StreamFilterExample {
	public static void main(String[] args) {
		...
		System.out.println();
		// Doing the same exact thing as the code above but just by using stream API,
		// which just uses one line of code

		List<Product> list2 = getProducts().stream().filter((product) -> product.getPrice() > 2500f)
